...
func UpdateSimpleProduct(product request.AddUpdateProductRequest, tokens, locale string, visibility int, stock string) (string, int, error) {
	// get token
	...
	jsonStr := prepareSimpleData(product, cleanedToken, locale, visibility, stock)
