...
func UpdateConfigurableProduct(product request.AddUpdateProductRequest, sku, tokens, locale string, visibility int) (string, int, error, string) {
	// get token
	...
	jsonStr := prepareConfigurableData(product, sku, cleanedToken, locale, visibility, true)
